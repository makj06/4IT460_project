...
dfSelected=df[['vekova_kategorie','vzdelani', 'pohlavi', 'kraj', 'velikost_bydliste', 'politické_preference', 'prime_platby_cekani_planovane_vykony']]
...
clm = cleverminer(df=df,target='prime_platby_cekani_planovane_vykony',proc='CFMiner',
