...
dfSelected=df[['souhrn_spokojenost_zdr_zarizeni','politicke_preference', 'spokojenost_nemocnice', 'spokojenost_prakticky_lekar', 'spokojenost_ambulantni_specialiste']]
